...
import com.oneplus.avicii.NordLab.NordLab;
...
public class AutoHBMThresholdPreference extends CustomSeekBarPreference {
    ...
    public AutoHBMThresholdPreference(Context context, AttributeSet attrs) {
        ...
        mValue = Integer.parseInt(sharedPrefs.getString(NordLab.KEY_AUTO_HBM_THRESHOLD, context.getString(R.string.auto_hbm_threshold_preference_default)));
    ...
    protected void changeValue(int newValue) {
        ...
        prefChange.putString(NordLab.KEY_AUTO_HBM_THRESHOLD, String.valueOf(newValue)).commit();
    }
}
