...
public class ActionUtils {
    ...
    private static Intent getNordLabIntent(Context context) {
        Intent intent = new Intent();
        ComponentName cn=new ComponentName("com.oneplus.avicii.NordLab",
                "com.oneplus.avicii.NordLab.NordLabActivity");
        intent.setComponent(cn);
        return intent;
    }
    ...
    public static Intent getIntentByAction(Context context, int action) {
        ...
        if (action == TouchscreenGestureConstants.ACTION_BROWSER) {
            ...
            intent = getNordLabIntent(context);
    ...
    public static void triggerAction(Context context, int action) {
        ...
        if (km.isKeyguardLocked()) {
            intent = new Intent();
            intent.setClassName("com.oneplus.avicii.NordLab", "com.oneplus.avicii.NordLab.touch.ScreenOffLaunchGestureActivity");
