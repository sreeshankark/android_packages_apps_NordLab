...
import com.oneplus.avicii.NordLab.doze.DozeSettingsActivity;
...
import com.oneplus.avicii.NordLab.services.*;
import com.oneplus.avicii.NordLab.slider.SliderConstants;
import com.oneplus.avicii.NordLab.touch.TouchscreenGestureSettings;

public class NordLab extends PreferenceFragment
        implements Preference.OnPreferenceChangeListener {
    private static final String TAG = NordLab.class.getSimpleName();
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        if (isFeatureSupported(context, R.bool.config_deviceSupportsHBM)) {
            ...
            mAutoHBMSwitch.setChecked(PreferenceManager.getDefaultSharedPreferences(getContext()).getBoolean(NordLab.KEY_AUTO_HBM_SWITCH, false));
    ...
    public static boolean isAUTOHBMEnabled(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context).getBoolean(NordLab.KEY_AUTO_HBM_SWITCH, false);
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mAutoHBMSwitch) {
            ...
            Intent fpsinfo = new Intent(this.getContext(),
                    com.oneplus.avicii.NordLab.services.FPSInfoService.class);
            if (enabled) {
    ...
    public static class WarningDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            return new AlertDialog.Builder(getActivity())
                    .setTitle(R.string.nord_lab_warning_title)
                    .setMessage(R.string.nord_lab_warning_text)
                    .setNegativeButton(R.string.nord_lab_dialog, (dialog, which) -> dialog.cancel())
                    .create();
        }
