package com.oplus.settings.OPlusExtras.touch;
...
public class ActionUtils {
    ...
    private static Intent getOPlusExtrasIntent(Context context) {
        Intent intent = new Intent();
        ComponentName cn=new ComponentName("com.oplus.settings.OPlusExtras",
                "com.oplus.settings.OPlusExtras.OPlusExtrasActivity");
        intent.setComponent(cn);
        return intent;
    }
    ...
    public static void triggerAction(Context context, int action) {
        ...
        if (km.isKeyguardLocked()) {
            intent = new Intent();
            intent.setClassName("com.oplus.settings.OPlusExtras", "com.oplus.settings.OPlusExtras.touch.ScreenOffLaunchGestureActivity");
