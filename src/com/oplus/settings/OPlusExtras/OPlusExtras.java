...
import com.oplus.settings.OPlusExtras.doze.DozeSettingsActivity;
...
import com.oplus.settings.OPlusExtras.services.*;
import com.oplus.settings.OPlusExtras.slider.SliderConstants;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mAutoHBMSwitch) {
            ...
            Intent fpsinfo = new Intent(this.getContext(),
                    com.oplus.settings.OPlusExtras.services.FPSInfoService.class);
            if (enabled) {
